...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
      After being a {" "}
        <span className="font-medium">nurse</span> for over six years, I decided to pursue my
        ...
        I am also familiar with TypeScript, and always looking to learn new
        technologies. I'm currently looking for a{" "}
